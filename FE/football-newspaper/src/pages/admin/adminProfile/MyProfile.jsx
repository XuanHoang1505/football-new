...
const MyProfile = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Hồ sơ của tôi - Thể Thao 247</title>
      </Helmet>
                ...
                >
                  <Tab eventKey="profile" title="Thông Tin Cá Nhân">
                    <Row className="g-0">
                      <Col lg={4} className="pe-lg-2">
                        <div className="d-flex flex-column align-items-center p-4 py-lg-4 pt-5 bg-transparent">
                          <Image
                            src={
                              editProfile.avatar ||
                  ...
                  <Tab eventKey="contact" title="Thông Tin Liên Hệ">
                    {!isVerified ? (
                      ...
                      <Row className="bg-transparent p-4 mx-0">
                        <Col md={6}>
