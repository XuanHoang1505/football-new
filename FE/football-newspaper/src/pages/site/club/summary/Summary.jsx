          ...
          <div className={styles.card}>
            {lastMatch ? (
              <div className={styles.matchBox}>
                ...
                <Link className="d-flex mt-2" to={`/football/${lastMatch.competition.code}/`}>
                  <img
                    ...
                    className="me-2"
                  />
                  <p className={styles.league}>{lastMatch.competition.name}</p>
                </Link>
              </div>
            ) : (
              <p>Chưa có dữ liệu</p>
          ...
          <div className={styles.card}>
            {nextMatch ? (
              <>
                ...
                <Link className="d-flex mt-2" to={`/football/${nextMatch.competition.code}/`}>
                  <img
                    ...
                    className="me-2"
                  />
                  <p className={styles.league}>{nextMatch.competition.name}</p>
                </Link>
              </>
            ) : (
